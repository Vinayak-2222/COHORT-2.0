 ...
 * @desc Decrement item quantity in cart by one, minimum quantity is 1
 * @access Private
 * @argument productId - ID of the product to update
 * @argument variantId - ID of the variant to update
 */
router.patch(
    "/quantity/decrement/:productId/:variantId",authenticateUser,validateDecrementCartItemQuantity,decrementCartItemQuantity)
 ...
 */
router.delete(
    "/item/:productId/:variantId",authenticateUser,validateRemoveCartItem,removeCartItem)
/**
