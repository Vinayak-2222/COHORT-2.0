...
const MISTRAL_REQUEST_TIMEOUT_MS = Number(process.env.MISTRAL_REQUEST_TIMEOUT_MS ?? 180000);

const mistralHttpClient = new HTTPClient({
    fetcher: (input, init) => {
        const signal = AbortSignal.timeout(MISTRAL_REQUEST_TIMEOUT_MS);
